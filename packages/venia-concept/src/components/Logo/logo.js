...
const Logo = props => {
    ...
    return (
        <Image
            alt={data?data.logo_alt:title}
            classes={{ image: classes.logo }}
            height={data?data.logo_height:height}
            src={data?`/media/logo/${data.header_logo_src}`:logo}
            title={data?data.logo_alt:title}
            width={data?data.logo_width:width}
        />
    );
};
